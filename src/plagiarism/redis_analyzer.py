...
def analyze_plagiarism_redis(
    ...
    # Step 3: Get matching regions from token fingerprints
    matches = fingerprint_store.find_matching_regions(file1_hash, file2_hash)
    ...
    fingerprint_store.cache_similarity_result(
        file1_hash, file2_hash, ast_sim, merged_matches
    )
    
    return ast_sim, merged_matches
