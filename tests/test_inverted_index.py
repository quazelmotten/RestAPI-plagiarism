...
def create_test_fingerprints(base_hash: int, count: int) -> list:
    ...
    return [{"hash": base_hash + i, "start": (i, 0), "end": (i, 10)} for i in range(count)]
...
def test_inverted_index():
    ...
    logger.info("   Indexed file1: 100 fingerprints")
    ...
    logger.info("   Indexed file2: 100 fingerprints (50% overlap with file1)")
    ...
    logger.info("   Indexed file3: 100 fingerprints (15% overlap with file1)")
    ...
    logger.info("   Indexed file4: 100 fingerprints (5% overlap with file1)")
    ...
    logger.info("   Expected: file1 (100%), file2 (50%)")
