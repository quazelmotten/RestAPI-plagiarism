...
from cli.analyzer import Analyzer  # noqa: E402
...
def main():
    parser = argparse.ArgumentParser(description="Benchmark analyzer.Start() speed")
    parser.add_argument(
        "--max-files",
        type=int,
        default=None,
    ...
    parser.add_argument(
        "--iterations", type=int, default=3, help="Number of iterations per pair (default: 3)"
    )
    parser.add_argument(
