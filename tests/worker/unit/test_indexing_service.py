...
class TestIndexingService:
    ...
    def test_index_file_handles_fingerprint_failure_logs_error(self, service, mock_fingerprint_svc, caplog):
    ...
    def test_ensure_files_indexed_continues_on_partial_failure(self, service, mock_fingerprint_svc, caplog):
